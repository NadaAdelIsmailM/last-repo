...
void ActionEdit::Execute()
{
	...
	// // // // // // / //
		pUI->ClearStatusBar();
		comp1 = pManager->GetComponentByCoordinates(x, y);
		conn1 = pManager->GetConnByCoordinates(x, y);
		if (comp1 != nullptr) {
			...
			case BUZZER:
			{
				...
				int intValue;
					do {
						value = pUI->GetString("enter 1 to edit the label, 2 to the edit resistace value or 3 to cancel ", "");
					...
					case 1:
					{
						...
						value = pUI->GetString(comp1->getLabel(), comp1->getLabel());
						comp1->setlabel(value);
						break;
					}
					case 2:
					{
						value = pUI->GetString(to_string(comp1->getResistance()), to_string(comp1->getResistance()));
			...
			{	//pUI->PrintMsg("enter 1 to edit the label, 2 to the edit Maximum Fuze current value or 3 to cancel ","");
				...
				int intValue;
				do {
					value = pUI->GetString("enter 1 to edit the label, 2 to the edit Switch status or 3 to cancel ", "");
				} while (value != "1" && value != "2" && value != "3");
				intValue = stod(value);
				switch (intValue) {
				case 1:
				...
				case 2:
				{
					value = pUI->GetString(to_string(comp1->getCompState()), to_string(comp1->getCompState()));
			...
			{	//pUI->PrintMsg("enter 1 to edit the label, 2 to the edit Maximum Fuze current value or 3 to cancel ","");
				...
				int intValue;
				do {
					value = pUI->GetString("enter 1 to edit the label, 2 to the edit Battery voltage or 3 to cancel ", "");
				} while (value != "1" && value != "2" && value != "3");
				intValue = stod(value);
				switch (intValue) {
				case 1:
				...
				case 2:
				{
					value = pUI->GetString(to_string(comp1->getSourceVoltage()), to_string(comp1->getSourceVoltage()));
			...
			{	//pUI->PrintMsg("enter 1 to edit the label, 2 to the edit Maximum Fuze current value or 3 to cancel ","");
				...
				int intValue;
				do {
					value = pUI->GetString("enter 1 to edit the label or 2 to cancel ", "");
		...
		int intValue;
		do {
			value = pUI->GetString("enter 1 to edit the label,2 to change terminals or 3 to cancel ", "");
		} while (value != "1" && value != "2" && value != "3");
		intValue = stod(value);
		switch (intValue) {
		case 1:
		{
			...
			value = pUI->GetString(conn1->getLabel(), conn1->getLabel());
		...
		case 2: {
			...
			pUI->GetPointClicked(x, y);
			pUI->ClearStatusBar();
			Component* tempComp1 = pManager->GetComponentByCoordinates(x, y);
			Component* tempComp2;
			if (tempComp1 != nullptr) {
				...
				if (compnum != 0) {
					...
					pUI->GetPointClicked(x, y);
					pUI->ClearStatusBar();
					tempComp2 = pManager->GetComponentByCoordinates(x, y);
